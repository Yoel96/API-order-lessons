...
router.get('/:id', checkAuth,(req,res,next)=>{  checkRole(req, res,next,["admin","student","teacher"])  },  getSubjectsByLessonType)
router.post('/addLessonType', checkAuth,(req,res,next)=>{  checkRole(req, res,next,["admin"])  }, addLessonType)
